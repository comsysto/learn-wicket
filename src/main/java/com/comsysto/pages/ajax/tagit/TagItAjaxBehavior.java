...
public abstract class TagItAjaxBehavior<T> extends AbstractAjaxBehavior {
	...
	public void renderHead(final Component component, final IHeaderResponse response) {
        ...
        response.render(JavaScriptHeaderItem.forReference(new TagItResourceReference()));
	...
	protected TextTemplate getTagItConfig() {
		return new PackageTextTemplate(TagItAjaxBehavior.class, "js/tag-it.template.js");
	}
